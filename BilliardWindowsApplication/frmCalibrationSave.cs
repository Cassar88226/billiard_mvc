	...
	public partial class frmCalibrationSave : Form
	{
		...
		private void pictureBox2_Click(object sender, EventArgs e)
		{
			try
			{
				...
				if (bCameaCalibrated)
				{
					MessageBox.Show("Camera has been calibrated Successfully." + Environment.NewLine + "Application should be restart", "Biliardoprofessionale", MessageBoxButtons.OK, MessageBoxIcon.Information);
					Application.Restart();
				}
		...
		private void pictureBox3_Click(object sender, EventArgs e)
		{
			...
			try
			{
				...
				const int nDefaultWidth = 644;
				const int nDefaultHeight = 310;
				...
				ptCalibPos[4] = BallTrackAPI.ptCorners[4];
				ptCalibPos[5] = BallTrackAPI.ptCorners[0];
		...
		public void CameraClibration()
		{
			try
			{
				...
				Point[] ptRotatedPoints = new Point[5];
				...
				BallTrackAPI.ptCorner_new[4].x = (BallTrackAPI.ptCorner_new[0].x + BallTrackAPI.ptCorner_new[1].x + BallTrackAPI.ptCorner_new[2].x + BallTrackAPI.ptCorner_new[3].x) / 4;
				BallTrackAPI.ptCorner_new[4].y = (BallTrackAPI.ptCorner_new[0].y + BallTrackAPI.ptCorner_new[1].y + BallTrackAPI.ptCorner_new[2].y + BallTrackAPI.ptCorner_new[3].y) / 4;
				BallTrackAPI.ptCorner_new[5].x = BallTrackAPI.ptCorner_new[4].x + 1;
				BallTrackAPI.ptCorner_new[5].y = BallTrackAPI.ptCorner_new[4].y + 1;
