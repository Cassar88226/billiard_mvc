...
namespace BilliardWindowsApplication
{
    public partial class frmGameScore : Form
    {
        ...
        //---------------------------------------------------  global varable used in this form---------------------------------------------------//
        ...
        /// <summary>
        /// this set is started by first player then true if second player then false
        /// </summary>
        bool startset = true;
        /// <summary>
        /// current playing turn of first player then true if second player then false
        /// </summary>
        bool playturn1 = true;
        /// <summary>
        /// game is pause or not
        /// </summary>
        bool gamepause = true;
        /// <summary>
        /// used to give chane to write score
        /// </summary>
        int timertick = 0;
        /// <summary>
        /// extra time is enabled for first player
        /// </summary>
        bool extratime1 = true;
        /// <summary>
        /// extra time is enabled for second player
        /// </summary>
        bool extratime2 = true;
        /// <summary>
        /// how many set is win by first player
        /// </summary>
        int set1 = 0;
        /// <summary>
        /// how many set is win by second player
        /// </summary>
        int set2 = 0;
        /// <summary>
        /// handicap is enabled 
        ...
        bool handicap = false;
        /// <summary>
        /// score transfer button is on
        /// </summary>
        bool rightscore = false;
        /// <summary>
        /// score delete button is on
        /// </summary>
        bool UpScore = false;
        ...
        /// <summary>
        /// list of memories of sets
        /// </summary>
        List<List<memorydetails>> memorylist = new List<List<memorydetails>>();    
        /// <summary>
        /// list of memory details in currrent set
        /// </summary>
        ...
        /// <summary>
        /// write html code for email
        /// </summary>
        /// <param name="TimeFinish"> finish time of fame</param>
        /// <param name="firstwin"> team 1 won the match</param>
        /// <param name="p1"> points of first team </param>
        /// <param name="p2"> points of second team</param>
        /// <param name="tabledetails"> list of memory of all sets </param>
        /// <returns></returns>
        string htmlcode(string TimeFinish, bool firstwin, int p1, int p2, List<List<memorydetails>> tabledetails)
        {
			...
			"<head> <title> </title> </head> <body>    <img src = " + '"' + BLL_BilliardWindowsApplication.originalLocation + "img/logoTop.png" + '"' + " /><br /><br />" +
        ...
        /// </summary>
        /// <param name="recepientEmail"> list of email id</param>
        /// <param name="subject"> email subject </param>
        /// <param name="body"> email body or html code</param>
        private void SendHtmlFormattedEmail(List<string> recepientEmail, string subject, string body)
        {
            try
            {
                using (MailMessage mailMessage = new MailMessage())
                {
                    ...
                    SmtpClient smtp = new SmtpClient("smtp.biliardoprofessionale.it", 587);
        ...
        private void timer3_Tick(object sender, EventArgs e)
        {
            ...
            if (playturn1 == true)
            {
                ...
                else
                {
                    ...
                    memory.Add(m2); 
                    addm2 = addm1=false; 
                    if (Convert.ToInt32(lblWPoint.Tag) < 1)
                    {
                        gamepause = true;
                        ...
                        if (BLL_BilliardWindowsApplication.set / 2 < set1)
                        {
                            new frmwiner(lblPlayer1.Text, lblPlayer3.Text, set1 + 1, set2, lblWscoreboard.Text, lblYscoreboard.Text, true).ShowDialog();
                        ...
                        if (BLL_BilliardWindowsApplication.set > (set1+set2))
                        {
                            new frmwiner(lblPlayer1.Text, lblPlayer3.Text, set1 + 1, set2, lblWscoreboard.Text, lblYscoreboard.Text, false).ShowDialog();
            ...
            else if (playturn1 == false)
            {
                ...
                else
                {
                    ...
                    if (Convert.ToInt32(lblYPoint.Tag) < 1)
                    {
                        ...
                        {
                            new frmwiner(lblPlayer2.Text, lblPlayer4.Text, set1, set2 + 1, lblWscoreboard.Text, lblYscoreboard.Text,true).ShowDialog();
                            timer1.Enabled = false;
                            if (BLL_BilliardWindowsApplication.email)
                            {
                        ...
                        {
                            new frmwiner(lblPlayer2.Text, lblPlayer4.Text, set1, set2 + 1, lblWscoreboard.Text, lblYscoreboard.Text, false).ShowDialog();
                            if ((BLL_BilliardWindowsApplication.set % 2) == 1 && BLL_BilliardWindowsApplication.set-(set1+set2)==1)
                            {
                                MessageBox.Show("rafree must select the last set");
                                gamepause = true;
