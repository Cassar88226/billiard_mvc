...
namespace BilliardWindowsApplication
{
    class BLL_BilliardWindowsApplication
    {
		...
		public static string weblocation = "http://track.biliardoprofessionale.it/";
		public static string originalLocation = "http://score.biliardoprofessionale.it/";
        //public static string weblocation = "http://track.biliardoprofessionale.it/";
    ...
    {
        static biliardService.BilliardScoreboard API = new biliardService.BilliardScoreboard();
        public static TimeSpan convertDbToTime(string DbTime)
        {
