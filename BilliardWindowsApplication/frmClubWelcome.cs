    ...
    public partial class frmClubWelcome : Form
    {
        ...
        private void pictureBox3_Click(object sender, EventArgs e)
        {
           ...
           if (BallTrackAPI.m_nInputMethod == 1)
               BallTrackAPI.BTAPI_OpenVideoFile("D:\\Document\\sample\\BBT\\calib\\1.avi");
           else
           {
			   if (!BallTrackAPI.BTAPI_ConnectCamera(IntPtr.Zero))
			   {
		   ...
		   {
			   BallTrackAPI.ptCorners[4] = BallTrackAPI.ptCenter;
			   BallTrackAPI.ptCorners[5].x = BallTrackAPI.ptCenter.x + 1;
			   BallTrackAPI.ptCorners[5].y = BallTrackAPI.ptCenter.y + 1;
			   frms.ShowDialog();
		   }
		   else frm.ShowDialog();   
        }
